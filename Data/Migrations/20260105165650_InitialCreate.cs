        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepartmentRemainingBudget = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    ...
                    UpdatedByIp = table.Column<string>(type: "nvarchar(45)", maxLength: 45, nullable: true),
                    UpdatedByUserAgent = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinanceNotes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ...
                    PoFilePath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseRequests_AspNetUsers_FinanceApproverId",
                        column: x => x.FinanceApproverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseRequests_AspNetUsers_ManagerApproverId",
                        column: x => x.ManagerApproverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseRequests_AspNetUsers_RejectedById",
                        column: x => x.RejectedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseRequests_AspNetUsers_RequesterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestItems_PurchaseRequests_PurchaseRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalHistories_ApprovedAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalHistories_PurchaseRequestId_ApprovalLevel",
                table: "ApprovalHistories",
                columns: new[] { "PurchaseRequestId", "ApprovalLevel" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Budgets_DepartmentId_Year",
                table: "Budgets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseRequests_FinanceApproverId",
                table: "PurchaseRequests",
                column: "FinanceApproverId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseRequests_ManagerApproverId",
                table: "PurchaseRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseRequests_RejectedById",
                table: "PurchaseRequests",
                column: "RejectedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestItems_PurchaseRequestId",
                table: "RequestItems",
                column: "PurchaseRequestId");

            migrationBuilder.AddForeignKey(
                name: "FK_ApprovalHistories_AspNetUsers_ApproverUserId",
                table: "ApprovalHistories",
                column: "ApproverUserId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
